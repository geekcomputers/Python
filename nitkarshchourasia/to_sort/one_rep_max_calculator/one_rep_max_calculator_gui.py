...
class OneRepMaxCalculator:
    ...
    def toggle_theme(self) -> None:
        ...
        for widget in self.window.winfo_children():
            if isinstance(widget, tk.Label) or isinstance(widget, tk.Button):
                ...
                for sub_widget in widget.winfo_children():
                    if isinstance(sub_widget, tk.Label) or isinstance(sub_widget, tk.Button):
        ...
        self.result_value_label.configure(fg="#22A7F0" if self.is_dark_mode else "#1E88E5")
        self.formula_info_label.configure(fg="#888888" if self.is_dark_mode else "#666666")
