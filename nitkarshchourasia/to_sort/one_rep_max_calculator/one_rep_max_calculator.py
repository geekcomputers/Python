class OneRepMaxCalculator:
    """A class to calculate the one-repetition maximum (1RM) for a
    ...
    def get_user_input(self):
        """Prompts the user to enter the weight lifted and the number of reps
        performed."""
...
def main():
    """The main function that creates an instance of OneRepMaxCalculator and
    uses it to get user input, calculate the one-rep max, and display the
    result."""
