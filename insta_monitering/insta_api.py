...
class StartHandlerinsta(tornado.web.RequestHandler):
    ...
    @run_on_executor
    def background_task(
        self, user: str, tags: str, monitor_type: str, product_id: str
    ) -> None:
        """
    ...
    def get(self) -> None:
        ...
        try:
            ...
            self.background_task(
                user, tags=q, monitor_type=monitor_type, product_id=product_id
            )
    ...
    def get(self) -> None:
        ...
        try:
            ...
            response = {
                ...
                "productId": product_id,
                "status": result,
                "message": f"Monitoring stopped for {q}"
                if result
                else f"Monitoring not found for {q}",
            }
...
if __name__ == "__main__":
    ...
    print(
        f"MongoDB connection: {con_file.host}:{con_file.mongoPort}"
