...
r1=tkinter.Label(root,text="",textvariable=result1,fg="green",bg="white",font=('lucida handwriting',15,'bold','underline'))
r1.place(x=10,y=150)
result2=tkinter.StringVar()
r2=tkinter.Label(root,text="",textvariable=result2,fg="green",bg="white",font=('lucida handwriting',15,'bold','underline'))
r2.place(x=0,y=380)
a=tkinter.Entry(root,text="",textvariable=name1,bd=5,bg="light grey",fg="red",font=("bold",20))
a.place(x=0,y=50)
b=tkinter.Entry(root,text="",textvariable=name2,bd=5,bg="light grey",fg="red",font=("bold",20))
b.place(x=0,y=270)
t1=tkinter.Label(root,text="TYPE MESSAGE:",font=('arial',20,'bold','underline'),fg="red")
t2=tkinter.Label(root,text="TYPE SECRET MESSAGE:",font=('arial',20,'bold','underline'),fg="red")
t1.place(x=10,y=0)
t2.place(x=10,y=220)
...
bt2=tkinter.Button(root,text="OK",bg="white",fg="black",bd=5,command=show2,font=('calibri',15,'bold','underline'))
