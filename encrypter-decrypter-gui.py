...
class Notebook:
    def __init__(self, parent):
        ...
        # ----- LabelFrames -----
        self.page1_main_label = ttk.LabelFrame(self.page1, text='Encrypt Any Text')  # <----- Page1 LabelFrame1
        ...
        self.page2_main_label = ttk.LabelFrame(self.page2, text='Decrypt Any Text')  # <----- Page1 LabelFrame1
    ...
    def backend_work(self, todo, text_coming):
        ...
        if todo == 'Encrypt':
            try:
                text_coming = str(text_coming).lower()  # <----- Lowering the letters as dic in lower letter
